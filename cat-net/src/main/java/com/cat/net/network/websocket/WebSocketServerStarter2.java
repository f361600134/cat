 ...
 * @date 2020年7月9日
 */
public class WebSocketServerStarter2 extends AbstractServer {

	private static final Logger log = LoggerFactory.getLogger(WebSocketServerStarter2.class);
...
//	}
	...
	public WebSocketServerStarter2 (IControllerDispatcher serverHandler, NetConfig config) {
		super(config.getServerIp(), config.getTcpPort());
		this.serverHandler = serverHandler;
	}
	
	public WebSocketServerStarter2 (IControllerDispatcher serverHandler, String ip, int port) {
		super(ip, port);
		this.serverHandler = serverHandler;
	}
