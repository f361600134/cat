...
public class StateUtils {
	 ...
	 * 判断是否存在状态
	 */
	public static boolean check(long state, long curState) {
	 ...
	 * 增加状态
	 */
	public static long addState(long state, long curState) {
	 ...
	 * 清除一个状态
	 */
	public static long removeState(long state, long curState) {
		return curState & ~state;
	}
